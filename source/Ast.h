...
using Expr = std::variant<LiteralExpr, StringLiteral, UnaryExpr, BinaryExpr, VariableExpr, CallExpr, GetPropertyExpr,
                          ...
                          ReturnExpr, ThisExpr, ObjectExpr>;
using ExprHandle = std::unique_ptr<Expr>;

using Stmt = std::variant<VarStmt, ExprStmt, FunctionStmt, ClassStmt, NativeStmt, FieldStmt, MethodStmt, ConstructorStmt
                          , ObjectStmt, TraitStmt, UsingStmt>;
