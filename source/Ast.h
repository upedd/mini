...
using Expr = std::variant<LiteralExpr, StringLiteral, UnaryExpr, BinaryExpr, VariableExpr, CallExpr, GetPropertyExpr, SuperExpr, BlockExpr>;
using ExprHandle = std::unique_ptr<Expr>;

using Stmt = std::variant<VarStmt, ExprStmt, IfStmt, WhileStmt, FunctionStmt, ReturnStmt, ClassStmt, NativeStmt>;
